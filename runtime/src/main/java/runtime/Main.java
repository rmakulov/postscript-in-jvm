...
/**************************************************************
  ...
  Version 1.2.5, 7/25/99-5/16/00, [C. Scott Ananian]
   ...
   CUP scanner integration improved according to suggestions made by
     David MacMahon <davidm@smartsc.com>.  The %cup directive now tells
     JLex to generate a scanner conforming to the java_cup.runtime.Scanner
...
class CMakeNfa
{
  ...
  /***************************************************************
    Function: machine
    Description: Recursive descent regular expression scanner.
    **************************************************************/
