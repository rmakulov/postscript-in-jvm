 ...
 */
public class ArithmethicBytecodeGenerator implements Opcodes {
    ...
    public ArithmethicBytecodeGenerator() {
        argsCount = 0;
    ...
    private PSArithmethicBytecode cur = null;
...
//         Check if we collect smth, have some args and smth contains not only from numbers.
    ...
    private void runFragment(String str) {
        ...
        cur = new PSArithmethicBytecode(Integer.toString(classNumber), args);
    }
}
