    ...
    public void execute() {
        ...
        try {
            if (o1.getType() == Type.INTEGER && o2.getType() == Type.INTEGER) {
                runtime.pushToOperandStack(new PSObject(new PSInteger(((Integer) asm.getMethod("iadd", int.class, int.class).invoke(null, (int) r1, (int) r2)))));
                return;
            }
            dRes = (Double) asm.getMethod("add", double.class, double.class).invoke(null, r1, r2);
